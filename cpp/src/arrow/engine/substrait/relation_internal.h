...
#include "substrait/extension_rels.pb.h" // IWYU pragma: export
...
/// @brief Create and return a default extension provider instance
ARROW_ENGINE_EXPORT std::shared_ptr<ExtensionProvider> GetDefaultExtensionProvider();
